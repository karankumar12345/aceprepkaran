...
const Page = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast("Go To Feedback Page")
      setTimeout(() => {
        router.push(`/dashboard/development-mcq/${interviewId}/feedback`);
      }, 2000);
    } catch (error) {
  ...
  return (
    <div className=" min-h-screen bg-gray-900">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 my-3 shadow-[0px_0px_48px_-6px_#ff24e1b3] bg-gray-900 text-gray-200">
          <Question
